...
main(int argc, char **argv)
{
  ...
  14:	90050513          	addi	a0,a0,-1792 # 910 <malloc+0xe8>
  ...
  42:	8d250513          	addi	a0,a0,-1838 # 910 <malloc+0xe8>
  ...
  6a:	8b250513          	addi	a0,a0,-1870 # 918 <malloc+0xf0>
  6e:	706000ef          	jal	ra,774 <printf>
    exit(1);
  72:	4505                	li	a0,1
  74:	2e4000ef          	jal	ra,358 <exit>
    fprintf(2, "%s: cannot stat %s\n", s, "ff");
  78:	00001697          	auipc	a3,0x1
  7c:	8b868693          	addi	a3,a3,-1864 # 930 <malloc+0x108>
  80:	8626                	mv	a2,s1
  82:	00001597          	auipc	a1,0x1
  86:	8b658593          	addi	a1,a1,-1866 # 938 <malloc+0x110>
  8a:	4509                	li	a0,2
  8c:	6be000ef          	jal	ra,74a <fprintf>
    exit(1);
  90:	4505                	li	a0,1
  ...
  9c:	8b850513          	addi	a0,a0,-1864 # 950 <malloc+0x128>
  a0:	6d4000ef          	jal	ra,774 <printf>
    exit(1);
  a4:	4505                	li	a0,1
  ...
  b2:	8d250513          	addi	a0,a0,-1838 # 980 <malloc+0x158>
  b6:	6be000ef          	jal	ra,774 <printf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 438:	57450513          	addi	a0,a0,1396 # 9a8 <digits>
 43c:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	4b4c8c93          	addi	s9,s9,1204 # 9a8 <digits>
 ...
 71c:	28890913          	addi	s2,s2,648 # 9a0 <malloc+0x178>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 884:	98878793          	addi	a5,a5,-1656 # 1208 <base>
