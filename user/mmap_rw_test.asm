...
int main(){
  ...
  32:	8a250513          	addi	a0,a0,-1886 # 8d0 <malloc+0xe4>
  36:	702000ef          	jal	ra,738 <printf>
  munmap(p, 8192);
  3a:	6589                	lui	a1,0x2
  3c:	8526                	mv	a0,s1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3fc:	4f050513          	addi	a0,a0,1264 # 8e8 <digits>
 400:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	430c8c93          	addi	s9,s9,1072 # 8e8 <digits>
 ...
 6e0:	20490913          	addi	s2,s2,516 # 8e0 <malloc+0xf4>
        for(; *s; s++)
