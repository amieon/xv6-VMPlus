...
int main(){
  ...
  24:	04200713          	li	a4,66
  28:	00e78023          	sb	a4,0(a5) # 1000 <freep>
  if(p[0]=='A' && p[4096]=='B') printf("RW PASS\n");
  2c:	00001517          	auipc	a0,0x1
  30:	87450513          	addi	a0,a0,-1932 # 8a0 <malloc+0xe6>
  34:	6d2000ef          	jal	ra,706 <printf>
  munmap(p, 8192);
  38:	6589                	lui	a1,0x2
  3a:	8526                	mv	a0,s1
  3c:	346000ef          	jal	ra,382 <munmap>
  exit(0);
  40:	4501                	li	a0,0
  42:	298000ef          	jal	ra,2da <exit>
...
strcpy(char *s, const char *t)
{
  ...
  while((*s++ = *t++) != 0)
  5c:	87aa                	mv	a5,a0
  5e:	0585                	addi	a1,a1,1 # 2001 <base+0xff1>
...
stat(const char *n, struct stat *st)
{
 ...
 196:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 198:	85ca                	mv	a1,s2
 19a:	198000ef          	jal	ra,332 <fstat>
 19e:	892a                	mv	s2,a0
  close(fd);
 1a0:	8526                	mv	a0,s1
 1a2:	160000ef          	jal	ra,302 <close>
  return r;
}
 1a6:	854a                	mv	a0,s2
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 29a:	f67ff0ef          	jal	ra,200 <memmove>
}
 29e:	60a2                	ld	ra,8(sp)
 2a0:	6402                	ld	s0,0(sp)
...
sbrk(int n) {
 ...
 2ae:	4585                	li	a1,1
 2b0:	0b2000ef          	jal	ra,362 <sys_sbrk>
}
 2b4:	60a2                	ld	ra,8(sp)
 2b6:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 2c4:	4589                	li	a1,2
 2c6:	09c000ef          	jal	ra,362 <sys_sbrk>
}
 2ca:	60a2                	ld	ra,8(sp)
 2cc:	6402                	ld	s0,0(sp)
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3ca:	4f250513          	addi	a0,a0,1266 # 8b8 <digits>
 3ce:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	432c8c93          	addi	s9,s9,1074 # 8b8 <digits>
 ...
 6ae:	20690913          	addi	s2,s2,518 # 8b0 <malloc+0xf6>
        for(; *s; s++)
