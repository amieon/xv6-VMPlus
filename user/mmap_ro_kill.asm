...
int main(){
  ...
  char *p = mmap(0, 4096, PROT_READ, MAP_ANON);
   ...
   e:	6585                	lui	a1,0x1
  10:	4501                	li	a0,0
  12:	35e000ef          	jal	ra,370 <mmap>
  16:	84aa                	mv	s1,a0
  printf("about to write (should die)\n");
  18:	00001517          	auipc	a0,0x1
  1c:	87850513          	addi	a0,a0,-1928 # 890 <malloc+0xe0>
  20:	6dc000ef          	jal	ra,6fc <printf>
  p[0] = 1; // 应该被 kill
  24:	4785                	li	a5,1
  26:	00f48023          	sb	a5,0(s1)
  printf("FAIL: still alive\n");
  2a:	00001517          	auipc	a0,0x1
  2e:	88650513          	addi	a0,a0,-1914 # 8b0 <malloc+0x100>
  32:	6ca000ef          	jal	ra,6fc <printf>
  exit(1);
  36:	4505                	li	a0,1
  38:	298000ef          	jal	ra,2d0 <exit>
...
strcpy(char *s, const char *t)
{
  ...
  while((*s++ = *t++) != 0)
  52:	87aa                	mv	a5,a0
  54:	0585                	addi	a1,a1,1 # 1001 <freep+0x1>
...
stat(const char *n, struct stat *st)
{
 ...
 18c:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 18e:	85ca                	mv	a1,s2
 190:	198000ef          	jal	ra,328 <fstat>
 194:	892a                	mv	s2,a0
  close(fd);
 196:	8526                	mv	a0,s1
 198:	160000ef          	jal	ra,2f8 <close>
  return r;
}
 19c:	854a                	mv	a0,s2
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 290:	f67ff0ef          	jal	ra,1f6 <memmove>
}
 294:	60a2                	ld	ra,8(sp)
 296:	6402                	ld	s0,0(sp)
...
sbrk(int n) {
 ...
 2a4:	4585                	li	a1,1
 2a6:	0b2000ef          	jal	ra,358 <sys_sbrk>
}
 2aa:	60a2                	ld	ra,8(sp)
 2ac:	6402                	ld	s0,0(sp)
...
sbrklazy(int n) {
 ...
 2ba:	4589                	li	a1,2
 2bc:	09c000ef          	jal	ra,358 <sys_sbrk>
}
 2c0:	60a2                	ld	ra,8(sp)
 2c2:	6402                	ld	s0,0(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 480:	454c8c93          	addi	s9,s9,1108 # 8d0 <digits>
 ...
 6a4:	22890913          	addi	s2,s2,552 # 8c8 <malloc+0x118>
        for(; *s; s++)
