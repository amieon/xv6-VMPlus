...
int main(){
  ...
  1e:	88650513          	addi	a0,a0,-1914 # 8a0 <malloc+0xde>
  22:	6ec000ef          	jal	ra,70e <printf>
  p[0] = 1; // 应该被 kill
  26:	4785                	li	a5,1
  28:	00f48023          	sb	a5,0(s1)
  printf("FAIL: still alive\n");
  2c:	00001517          	auipc	a0,0x1
  30:	89450513          	addi	a0,a0,-1900 # 8c0 <malloc+0xfe>
  34:	6da000ef          	jal	ra,70e <printf>
  exit(1);
  38:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3d2:	51250513          	addi	a0,a0,1298 # 8e0 <digits>
 3d6:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 492:	452c8c93          	addi	s9,s9,1106 # 8e0 <digits>
 ...
 6b6:	22690913          	addi	s2,s2,550 # 8d8 <malloc+0x116>
        for(; *s; s++)
