...
main(int argc, char **argv)
{
  ...
  10:	91450513          	addi	a0,a0,-1772 # 920 <malloc+0xea>
  14:	374000ef          	jal	ra,388 <mkdir>
  18:	c919                	beqz	a0,2e <main+0x2e>
    printf("%s: mkdir dd failed\n", s);
  1a:	85a6                	mv	a1,s1
  1c:	00001517          	auipc	a0,0x1
  20:	90c50513          	addi	a0,a0,-1780 # 928 <malloc+0xf2>
  24:	758000ef          	jal	ra,77c <printf>
    exit(1);
  28:	4505                	li	a0,1
  ...
  32:	8f250513          	addi	a0,a0,-1806 # 920 <malloc+0xea>
  36:	35a000ef          	jal	ra,390 <chdir>
  3a:	c919                	beqz	a0,50 <main+0x50>
    printf("%s: chdir dd failed\n", s);
  3c:	85a6                	mv	a1,s1
  3e:	00001517          	auipc	a0,0x1
  42:	90250513          	addi	a0,a0,-1790 # 940 <malloc+0x10a>
  46:	736000ef          	jal	ra,77c <printf>
    exit(1);
  4a:	4505                	li	a0,1
  ...
  54:	90850513          	addi	a0,a0,-1784 # 958 <malloc+0x122>
  ...
  64:	91850513          	addi	a0,a0,-1768 # 978 <malloc+0x142>
  68:	714000ef          	jal	ra,77c <printf>
  ...
  7c:	8e850513          	addi	a0,a0,-1816 # 960 <malloc+0x12a>
  80:	6fc000ef          	jal	ra,77c <printf>
    exit(1);
  84:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	4a4c8c93          	addi	s9,s9,1188 # 9a0 <digits>
 ...
 724:	27890913          	addi	s2,s2,632 # 998 <malloc+0x162>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 892:	97a78793          	addi	a5,a5,-1670 # 1208 <base>
