...
main(void)
{
  ...
  96:	8fe50513          	addi	a0,a0,-1794 # 990 <malloc+0x154>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 44c:	56850513          	addi	a0,a0,1384 # 9b0 <digits>
 450:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50c:	4a8c8c93          	addi	s9,s9,1192 # 9b0 <digits>
 ...
 730:	27c90913          	addi	s2,s2,636 # 9a8 <malloc+0x16c>
        for(; *s; s++)
