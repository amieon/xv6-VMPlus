...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3a2:	0805c163          	bltz	a1,424 <printint+0x94>
  neg = 0;
 3a6:	4881                	li	a7,0
 ...
 3b2:	4da50513          	addi	a0,a0,1242 # 888 <digits>
 3b6:	883e                	mv	a6,a5
 ...
 3d0:	fec773e3          	bgeu	a4,a2,3b6 <printint+0x26>
  if(neg)
 3d4:	00088b63          	beqz	a7,3ea <printint+0x5a>
    buf[i++] = '-';
 ...
 3e6:	0028079b          	addiw	a5,a6,2
  ...
  while(--i >= 0)
 3ea:	02f05663          	blez	a5,416 <printint+0x86>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 44e:	24090c63          	beqz	s2,6a6 <vprintf+0x27a>
 452:	8b2a                	mv	s6,a0
 454:	8a2e                	mv	s4,a1
 456:	8bb2                	mv	s7,a2
  state = 0;
 ...
 472:	41ac8c93          	addi	s9,s9,1050 # 888 <digits>
 476:	a005                	j	496 <vprintf+0x6a>
        putc(fd, c0);
 478:	85ca                	mv	a1,s2
 47a:	855a                	mv	a0,s6
 47c:	ef7ff0ef          	jal	ra,372 <putc>
 ...
 492:	20090a63          	beqz	s2,6a6 <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
 ...
 4a4:	b7cd                	j	486 <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 4a6:	c3c1                	beqz	a5,526 <vprintf+0xfa>
 ...
 4b6:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 4ba:	03878e63          	beq	a5,s8,4f6 <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
 4be:	05a78863          	beq	a5,s10,50e <vprintf+0xe2>
      } else if(c0 == 'u'){
 4c2:	0db78b63          	beq	a5,s11,598 <vprintf+0x16c>
 ...
 4ca:	10e78d63          	beq	a5,a4,5e4 <vprintf+0x1b8>
 ...
 4d2:	14e78263          	beq	a5,a4,616 <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 4d6:	06300713          	li	a4,99
 4da:	16e78f63          	beq	a5,a4,658 <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 4de:	07300713          	li	a4,115
 4e2:	18e78563          	beq	a5,a4,66c <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 4e6:	05579063          	bne	a5,s5,526 <vprintf+0xfa>
        putc(fd, '%');
 4ea:	85d6                	mv	a1,s5
 4ec:	855a                	mv	a0,s6
 4ee:	e85ff0ef          	jal	ra,372 <putc>
 ...
 502:	855a                	mv	a0,s6
 504:	e8dff0ef          	jal	ra,390 <printint>
 508:	8bca                	mv	s7,s2
      state = 0;
 50a:	4981                	li	s3,0
 50c:	bfad                	j	486 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 50e:	03868663          	beq	a3,s8,53a <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 512:	05a68163          	beq	a3,s10,554 <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
 516:	09b68d63          	beq	a3,s11,5b0 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 51a:	03a68f63          	beq	a3,s10,558 <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
 51e:	07800793          	li	a5,120
 522:	0cf68d63          	beq	a3,a5,5fc <vprintf+0x1d0>
        putc(fd, '%');
 526:	85d6                	mv	a1,s5
 528:	855a                	mv	a0,s6
 52a:	e49ff0ef          	jal	ra,372 <putc>
        putc(fd, c0);
 52e:	85ca                	mv	a1,s2
 530:	855a                	mv	a0,s6
 532:	e41ff0ef          	jal	ra,372 <putc>
      state = 0;
 536:	4981                	li	s3,0
 538:	b7b9                	j	486 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 546:	855a                	mv	a0,s6
 548:	e49ff0ef          	jal	ra,390 <printint>
        i += 1;
 ...
 550:	4981                	li	s3,0
        i += 1;
 552:	bf15                	j	486 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 554:	03860563          	beq	a2,s8,57e <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 558:	07b60963          	beq	a2,s11,5ca <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 55c:	07800793          	li	a5,120
 560:	fcf613e3          	bne	a2,a5,526 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 570:	855a                	mv	a0,s6
 572:	e1fff0ef          	jal	ra,390 <printint>
        i += 2;
 ...
 58a:	855a                	mv	a0,s6
 58c:	e05ff0ef          	jal	ra,390 <printint>
        i += 2;
 ...
 5a4:	855a                	mv	a0,s6
 5a6:	debff0ef          	jal	ra,390 <printint>
 5aa:	8bca                	mv	s7,s2
      state = 0;
 5ac:	4981                	li	s3,0
 5ae:	bde1                	j	486 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 5bc:	855a                	mv	a0,s6
 5be:	dd3ff0ef          	jal	ra,390 <printint>
        i += 1;
 ...
 5d6:	855a                	mv	a0,s6
 5d8:	db9ff0ef          	jal	ra,390 <printint>
        i += 2;
 ...
 5f0:	855a                	mv	a0,s6
 5f2:	d9fff0ef          	jal	ra,390 <printint>
 5f6:	8bca                	mv	s7,s2
      state = 0;
 5f8:	4981                	li	s3,0
 5fa:	b571                	j	486 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 608:	855a                	mv	a0,s6
 60a:	d87ff0ef          	jal	ra,390 <printint>
        i += 1;
 ...
 642:	855a                	mv	a0,s6
 644:	d2fff0ef          	jal	ra,372 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 648:	0992                	slli	s3,s3,0x4
 64a:	397d                	addiw	s2,s2,-1
 64c:	fe0916e3          	bnez	s2,638 <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
 650:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 654:	4981                	li	s3,0
 656:	bd05                	j	486 <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
 658:	008b8913          	addi	s2,s7,8
 65c:	000bc583          	lbu	a1,0(s7)
 660:	855a                	mv	a0,s6
 662:	d11ff0ef          	jal	ra,372 <putc>
 666:	8bca                	mv	s7,s2
      state = 0;
 668:	4981                	li	s3,0
 66a:	bd31                	j	486 <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 66c:	008b8993          	addi	s3,s7,8
 670:	000bb903          	ld	s2,0(s7)
 674:	00090f63          	beqz	s2,692 <vprintf+0x266>
        for(; *s; s++)
 678:	00094583          	lbu	a1,0(s2)
 67c:	c195                	beqz	a1,6a0 <vprintf+0x274>
          putc(fd, *s);
 67e:	855a                	mv	a0,s6
 680:	cf3ff0ef          	jal	ra,372 <putc>
        for(; *s; s++)
 684:	0905                	addi	s2,s2,1
 686:	00094583          	lbu	a1,0(s2)
 68a:	f9f5                	bnez	a1,67e <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 68c:	8bce                	mv	s7,s3
      state = 0;
 68e:	4981                	li	s3,0
 690:	bbdd                	j	486 <vprintf+0x5a>
          s = "(null)";
 692:	00000917          	auipc	s2,0x0
 696:	1ee90913          	addi	s2,s2,494 # 880 <malloc+0xde>
        for(; *s; s++)
 69a:	02800593          	li	a1,40
 69e:	b7c5                	j	67e <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 6a0:	8bce                	mv	s7,s3
      state = 0;
 6a2:	4981                	li	s3,0
 6a4:	b3cd                	j	486 <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 6dc:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 6e0:	8622                	mv	a2,s0
 6e2:	d4bff0ef          	jal	ra,42c <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 710:	85aa                	mv	a1,a0
 712:	4505                	li	a0,1
 714:	d19ff0ef          	jal	ra,42c <vprintf>
}
...
malloc(uint nbytes)
{
 ...
 856:	ecbff0ef          	jal	ra,720 <free>
  return freep;
 85a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 85e:	dd61                	beqz	a0,836 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 860:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 862:	4798                	lw	a4,8(a5)
 864:	fa9777e3          	bgeu	a4,s1,812 <malloc+0x70>
    if(p == freep)
 868:	00093703          	ld	a4,0(s2)
 86c:	853e                	mv	a0,a5
 86e:	fef719e3          	bne	a4,a5,860 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 872:	8552                	mv	a0,s4
 874:	a0bff0ef          	jal	ra,27e <sbrk>
  if(p == SBRK_ERROR)
 878:	fd551ce3          	bne	a0,s5,850 <malloc+0xae>
        return 0;
 87c:	4501                	li	a0,0
 87e:	bf65                	j	836 <malloc+0x94>
