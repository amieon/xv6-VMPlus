...
main(void)
{
  ...
  1e:	89650513          	addi	a0,a0,-1898 # 8b0 <malloc+0xe0>
  22:	6fa000ef          	jal	ra,71c <printf>
    exit(0);
  26:	4501                	li	a0,0
  ...
  3e:	88650513          	addi	a0,a0,-1914 # 8c0 <malloc+0xf0>
  42:	6da000ef          	jal	ra,71c <printf>
  exit(0);
  46:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a0:	43cc8c93          	addi	s9,s9,1084 # 8d8 <digits>
 ...
 6c4:	21090913          	addi	s2,s2,528 # 8d0 <malloc+0x100>
        for(; *s; s++)
