...
main(void)
{
  ...
  1e:	8b650513          	addi	a0,a0,-1866 # 8d0 <malloc+0xe0>
  22:	71a000ef          	jal	ra,73c <printf>
    exit(0);
  26:	4501                	li	a0,0
  ...
  3e:	8a650513          	addi	a0,a0,-1882 # 8e0 <malloc+0xf0>
  42:	6fa000ef          	jal	ra,73c <printf>
  exit(0);
  46:	4501                	li	a0,0
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 400:	4fc50513          	addi	a0,a0,1276 # 8f8 <digits>
 404:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	43cc8c93          	addi	s9,s9,1084 # 8f8 <digits>
 ...
 6e4:	21090913          	addi	s2,s2,528 # 8f0 <malloc+0x100>
        for(; *s; s++)
