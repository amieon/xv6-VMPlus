...
main(void)
{
  ...
  1e:	88650513          	addi	a0,a0,-1914 # 8a0 <malloc+0xe0>
  22:	6ea000ef          	jal	ra,70c <printf>
    exit(0);
  26:	4501                	li	a0,0
  ...
  3e:	87650513          	addi	a0,a0,-1930 # 8b0 <malloc+0xf0>
  42:	6ca000ef          	jal	ra,70c <printf>
  exit(0);
  46:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 490:	43cc8c93          	addi	s9,s9,1084 # 8c8 <digits>
 ...
 6b4:	21090913          	addi	s2,s2,528 # 8c0 <malloc+0x100>
        for(; *s; s++)
