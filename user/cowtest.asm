...
main(void)
{
  ...
  1e:	8c650513          	addi	a0,a0,-1850 # 8e0 <malloc+0xe8>
  22:	71c000ef          	jal	ra,73e <printf>
    exit(0);
  26:	4501                	li	a0,0
  28:	2ba000ef          	jal	ra,2e2 <exit>
  }
  wait(0);
  2c:	4501                	li	a0,0
  2e:	2bc000ef          	jal	ra,2ea <wait>
  printf("parent: x=%d\n", x);
  32:	00001597          	auipc	a1,0x1
  36:	fce5a583          	lw	a1,-50(a1) # 1000 <x>
  3a:	00001517          	auipc	a0,0x1
  3e:	8b650513          	addi	a0,a0,-1866 # 8f0 <malloc+0xf8>
  42:	6fc000ef          	jal	ra,73e <printf>
  exit(0);
  46:	4501                	li	a0,0
  48:	29a000ef          	jal	ra,2e2 <exit>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 402:	50a50513          	addi	a0,a0,1290 # 908 <digits>
 406:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c2:	44ac8c93          	addi	s9,s9,1098 # 908 <digits>
 ...
 6e6:	21e90913          	addi	s2,s2,542 # 900 <malloc+0x108>
        for(; *s; s++)
