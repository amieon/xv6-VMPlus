...
main(void)
{
  ...
  1e:	8b650513          	addi	a0,a0,-1866 # 8d0 <malloc+0xe8>
  22:	712000ef          	jal	ra,734 <printf>
    exit(0);
  26:	4501                	li	a0,0
  ...
  3e:	8a650513          	addi	a0,a0,-1882 # 8e0 <malloc+0xf8>
  42:	6f2000ef          	jal	ra,734 <printf>
  exit(0);
  46:	4501                	li	a0,0
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3f8:	50450513          	addi	a0,a0,1284 # 8f8 <digits>
 3fc:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b8:	444c8c93          	addi	s9,s9,1092 # 8f8 <digits>
 ...
 6dc:	21890913          	addi	s2,s2,536 # 8f0 <malloc+0x108>
        for(; *s; s++)
