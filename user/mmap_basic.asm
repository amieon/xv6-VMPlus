...
user/_mmap_basic:     file format elf64-littleriscv
...
main(void)
{
  ...
  40:	8f450513          	addi	a0,a0,-1804 # 930 <malloc+0xfa>
  44:	738000ef          	jal	ra,77c <printf>

  /* 解除内存映射 */
  if(munmap(p, len) < 0){
  48:	6589                	lui	a1,0x2
  4a:	8526                	mv	a0,s1
  4c:	37c000ef          	jal	ra,3c8 <munmap>
  ...
  58:	90450513          	addi	a0,a0,-1788 # 958 <malloc+0x122>
  5c:	720000ef          	jal	ra,77c <printf>
  exit(0);
  60:	4501                	li	a0,0
  62:	2be000ef          	jal	ra,320 <exit>
    printf("mmap failed\n");
  66:	00001517          	auipc	a0,0x1
  6a:	8ba50513          	addi	a0,a0,-1862 # 920 <malloc+0xea>
  6e:	70e000ef          	jal	ra,77c <printf>
    exit(1);
  72:	4505                	li	a0,1
  74:	2ac000ef          	jal	ra,320 <exit>
    printf("munmap failed\n");
  78:	00001517          	auipc	a0,0x1
  7c:	8d050513          	addi	a0,a0,-1840 # 948 <malloc+0x112>
...
strcpy(char *s, const char *t)
{
  ...
  a6:	fff5c703          	lbu	a4,-1(a1) # 1fff <base+0xfef>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 724:	24090913          	addi	s2,s2,576 # 960 <malloc+0x12a>
        for(; *s; s++)
