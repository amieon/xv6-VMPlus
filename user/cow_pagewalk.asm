...
main(void)
{
  ...
  58:	8bc50513          	addi	a0,a0,-1860 # 910 <malloc+0xea>
  ...
  a2:	8ba50513          	addi	a0,a0,-1862 # 958 <malloc+0x132>
  a6:	6cc000ef          	jal	ra,772 <printf>
  exit(0);
  aa:	4501                	li	a0,0
  ac:	2aa000ef          	jal	ra,356 <exit>
      printf("FAIL: parent page changed at %d\n", i);
  b0:	00001517          	auipc	a0,0x1
  b4:	88050513          	addi	a0,a0,-1920 # 930 <malloc+0x10a>
  b8:	6ba000ef          	jal	ra,772 <printf>
      exit(1);
  bc:	4505                	li	a0,1
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2b4:	fff6079b          	addiw	a5,a2,-1 # fff <digits+0x697>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f6:	476c8c93          	addi	s9,s9,1142 # 968 <digits>
 ...
 71a:	24a90913          	addi	s2,s2,586 # 960 <malloc+0x13a>
        for(; *s; s++)
