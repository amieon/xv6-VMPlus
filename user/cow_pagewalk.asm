...
main(void)
{
  ...
  58:	8ec50513          	addi	a0,a0,-1812 # 940 <malloc+0xe2>
  ...
  a6:	704000ef          	jal	ra,7aa <printf>
  exit(0);
  aa:	4501                	li	a0,0
  ac:	2aa000ef          	jal	ra,356 <exit>
      printf("FAIL: parent page changed at %d\n", i);
  b0:	00001517          	auipc	a0,0x1
  b4:	8b050513          	addi	a0,a0,-1872 # 960 <malloc+0x102>
  b8:	6f2000ef          	jal	ra,7aa <printf>
      exit(1);
  bc:	4505                	li	a0,1
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2b4:	fff6079b          	addiw	a5,a2,-1 # fff <digits+0x667>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 46e:	52e50513          	addi	a0,a0,1326 # 998 <digits>
 472:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52e:	46ec8c93          	addi	s9,s9,1134 # 998 <digits>
 ...
 752:	24290913          	addi	s2,s2,578 # 990 <malloc+0x132>
        for(; *s; s++)
