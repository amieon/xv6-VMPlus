...
main(int argc, char *argv[])
{
  ...
  54:	8c058593          	addi	a1,a1,-1856 # 910 <malloc+0x100>
  58:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	462c8c93          	addi	s9,s9,1122 # 938 <digits>
