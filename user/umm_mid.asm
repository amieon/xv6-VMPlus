...
user/_umm_mid:     file format elf64-littleriscv
...
main(void)
{
  ...
  96:	92650513          	addi	a0,a0,-1754 # 9b8 <malloc+0x144>
...
strcpy(char *s, const char *t)
{
  ...
  e4:	fff5c703          	lbu	a4,-1(a1) # fff <digits+0x627>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 47e:	55e50513          	addi	a0,a0,1374 # 9d8 <digits>
 482:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53e:	49ec8c93          	addi	s9,s9,1182 # 9d8 <digits>
 ...
 762:	27290913          	addi	s2,s2,626 # 9d0 <malloc+0x15c>
        for(; *s; s++)
