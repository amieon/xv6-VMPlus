...
main(void)
{
  ...
  2c:	04200793          	li	a5,66
  30:	00f90023          	sb	a5,0(s2) # 1000 <freep>
  p[8192] = 'C';
  34:	6789                	lui	a5,0x2
  ...
  68:	0007c603          	lbu	a2,0(a5) # 2000 <base+0xff0>
  6c:	0004c583          	lbu	a1,0(s1)
  70:	00001517          	auipc	a0,0x1
  74:	8e850513          	addi	a0,a0,-1816 # 958 <malloc+0x11e>
  78:	70e000ef          	jal	ra,786 <printf>
  ...
  94:	8f850513          	addi	a0,a0,-1800 # 988 <malloc+0x14e>
...
strcpy(char *s, const char *t)
{
  ...
  e0:	0785                	addi	a5,a5,1 # 1001 <freep+0x1>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 44a:	56250513          	addi	a0,a0,1378 # 9a8 <digits>
 44e:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50a:	4a2c8c93          	addi	s9,s9,1186 # 9a8 <digits>
 ...
 72e:	27690913          	addi	s2,s2,630 # 9a0 <malloc+0x166>
        for(; *s; s++)
