...
main(void)
{
  ...
  96:	90650513          	addi	a0,a0,-1786 # 998 <malloc+0x14c>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 45c:	56050513          	addi	a0,a0,1376 # 9b8 <digits>
 460:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51c:	4a0c8c93          	addi	s9,s9,1184 # 9b8 <digits>
 ...
 740:	27490913          	addi	s2,s2,628 # 9b0 <malloc+0x164>
        for(; *s; s++)
