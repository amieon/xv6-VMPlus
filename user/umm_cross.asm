...
main(void)
{
  ...
  68:	8fc50513          	addi	a0,a0,-1796 # 960 <malloc+0xf0>
  6c:	750000ef          	jal	ra,7bc <printf>
  ...
  80:	8f450513          	addi	a0,a0,-1804 # 970 <malloc+0x100>
  84:	738000ef          	jal	ra,7bc <printf>
  ...
  94:	91850513          	addi	a0,a0,-1768 # 9a8 <malloc+0x138>
  98:	724000ef          	jal	ra,7bc <printf>
  ...
  a8:	90c50513          	addi	a0,a0,-1780 # 9b0 <malloc+0x140>
  ac:	710000ef          	jal	ra,7bc <printf>

  // b[0] 已被 unmap（应死）
  printf("touch b[0] (should die): %c\n", b[0]);
  b0:	00094583          	lbu	a1,0(s2)
  b4:	00001517          	auipc	a0,0x1
  b8:	91c50513          	addi	a0,a0,-1764 # 9d0 <malloc+0x160>
  bc:	700000ef          	jal	ra,7bc <printf>
  ...
  ca:	92a50513          	addi	a0,a0,-1750 # 9f0 <malloc+0x180>
  ce:	6ee000ef          	jal	ra,7bc <printf>
  ...
  dc:	87850513          	addi	a0,a0,-1928 # 950 <malloc+0xe0>
  ...
  ee:	89650513          	addi	a0,a0,-1898 # 980 <malloc+0x110>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 480:	58c50513          	addi	a0,a0,1420 # a08 <digits>
 484:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 540:	4ccc8c93          	addi	s9,s9,1228 # a08 <digits>
 ...
 764:	2a090913          	addi	s2,s2,672 # a00 <malloc+0x190>
        for(; *s; s++)
