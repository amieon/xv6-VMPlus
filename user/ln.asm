...
main(int argc, char *argv[])
{
  ...
  14:	88058593          	addi	a1,a1,-1920 # 890 <malloc+0xe0>
  18:	4509                	li	a0,2
  1a:	6b8000ef          	jal	ra,6d2 <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  40:	86c58593          	addi	a1,a1,-1940 # 8a8 <malloc+0xf8>
  44:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 480:	44cc8c93          	addi	s9,s9,1100 # 8c8 <digits>
 ...
 6a4:	22090913          	addi	s2,s2,544 # 8c0 <malloc+0x110>
        for(; *s; s++)
