...
main(int argc, char *argv[])
{
  ...
  18:	4509                	li	a0,2
  1a:	6f0000ef          	jal	ra,70a <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  44:	4509                	li	a0,2
  46:	6c4000ef          	jal	ra,70a <fprintf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3f8:	51450513          	addi	a0,a0,1300 # 908 <digits>
 3fc:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b8:	454c8c93          	addi	s9,s9,1108 # 908 <digits>
 ...
 6dc:	22890913          	addi	s2,s2,552 # 900 <malloc+0x118>
        for(; *s; s++)
