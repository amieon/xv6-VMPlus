...
main(int argc, char **argv)
{
  ...
  40:	8a458593          	addi	a1,a1,-1884 # 8e0 <malloc+0xec>
  44:	4509                	li	a0,2
  46:	6d0000ef          	jal	ra,716 <fprintf>
    exit(1);
  4a:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 404:	50050513          	addi	a0,a0,1280 # 900 <digits>
 408:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c4:	440c8c93          	addi	s9,s9,1088 # 900 <digits>
 ...
 6e8:	21490913          	addi	s2,s2,532 # 8f8 <malloc+0x104>
        for(; *s; s++)
