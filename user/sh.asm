...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      5c:	4509                	li	a0,2
      5e:	7bf000ef          	jal	ra,101c <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e2:	4509                	li	a0,2
      e4:	739000ef          	jal	ra,101c <fprintf>
  exit(0);
      e8:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     116:	4509                	li	a0,2
     118:	705000ef          	jal	ra,101c <fprintf>
      exit(1);
     11c:	4505                	li	a0,1
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4c8:	d84b8b93          	addi	s7,s7,-636 # 1248 <malloc+0x14e>
  ...
  while(peek(ps, es, "<>")){
     ...
     4da:	d5250513          	addi	a0,a0,-686 # 1228 <malloc+0x12e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     5a6:	cae60613          	addi	a2,a2,-850 # 1250 <malloc+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ca:	caab0b13          	addi	s6,s6,-854 # 1270 <malloc+0x176>
  ...
  return ret;
     ...
     600:	c5c50513          	addi	a0,a0,-932 # 1258 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     652:	c1250513          	addi	a0,a0,-1006 # 1260 <malloc+0x166>
...
0000000000000668 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     684:	bf860613          	addi	a2,a2,-1032 # 1278 <malloc+0x17e>
     688:	85ce                	mv	a1,s3
     68a:	854a                	mv	a0,s2
...
00000000000006c2 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e0:	ba4a0a13          	addi	s4,s4,-1116 # 1280 <malloc+0x186>
  ...
  if(peek(ps, es, ";")){
     ...
     70a:	b8260613          	addi	a2,a2,-1150 # 1288 <malloc+0x18e>
     70e:	85ce                	mv	a1,s3
     710:	854a                	mv	a0,s2
...
000000000000074a <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     760:	af460613          	addi	a2,a2,-1292 # 1250 <malloc+0x156>
  ...
  if(!peek(ps, es, ")"))
     ...
     784:	b2060613          	addi	a2,a2,-1248 # 12a0 <malloc+0x1a6>
     788:	85ca                	mv	a1,s2
     78a:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7ba:	ada50513          	addi	a0,a0,-1318 # 1290 <malloc+0x196>
     7be:	88dff0ef          	jal	ra,4a <panic>
    panic("syntax - missing )");
     7c2:	00001517          	auipc	a0,0x1
     7c6:	ae650513          	addi	a0,a0,-1306 # 12a8 <malloc+0x1ae>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7ee:	b1e70713          	addi	a4,a4,-1250 # 1308 <malloc+0x20e>
...
000000000000084e <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87a:	a4a60613          	addi	a2,a2,-1462 # 12c0 <malloc+0x1c6>
     87e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8a8:	a2458593          	addi	a1,a1,-1500 # 12c8 <malloc+0x1ce>
     8ac:	4509                	li	a0,2
     8ae:	76e000ef          	jal	ra,101c <fprintf>
    panic("syntax");
     8b2:	00001517          	auipc	a0,0x1
     8b6:	9a650513          	addi	a0,a0,-1626 # 1258 <malloc+0x15e>
...
00000000000008be <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8d6:	a0648493          	addi	s1,s1,-1530 # 12d8 <malloc+0x1de>
     8da:	4589                	li	a1,2
     8dc:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97a:	96a58593          	addi	a1,a1,-1686 # 12e0 <malloc+0x1e6>
     97e:	4509                	li	a0,2
     980:	69c000ef          	jal	ra,101c <fprintf>
...
{
     ce8:	715d                	addi	sp,sp,-80
     cea:	e486                	sd	ra,72(sp)
     cec:	e0a2                	sd	s0,64(sp)
     cee:	fc26                	sd	s1,56(sp)
     cf0:	f84a                	sd	s2,48(sp)
     cf2:	f44e                	sd	s3,40(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     cf8:	c299                	beqz	a3,cfe <printint+0x16>
     cfa:	0805c163          	bltz	a1,d7c <printint+0x94>
  neg = 0;
     cfe:	4881                	li	a7,0
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d0a:	62250513          	addi	a0,a0,1570 # 1328 <digits>
     d0e:	883e                	mv	a6,a5
     ...
     d28:	fec773e3          	bgeu	a4,a2,d0e <printint+0x26>
  if(neg)
     d2c:	00088b63          	beqz	a7,d42 <printint+0x5a>
    buf[i++] = '-';
  ...
  while(--i >= 0)
     d42:	02f05663          	blez	a5,d6e <printint+0x86>
     d46:	fb840713          	addi	a4,s0,-72
     d4a:	00f704b3          	add	s1,a4,a5
     d4e:	fff70993          	addi	s3,a4,-1
     d52:	99be                	add	s3,s3,a5
     d54:	37fd                	addiw	a5,a5,-1
     d56:	1782                	slli	a5,a5,0x20
     d58:	9381                	srli	a5,a5,0x20
     d5a:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     d5e:	fff4c583          	lbu	a1,-1(s1)
     d62:	854a                	mv	a0,s2
     d64:	f67ff0ef          	jal	ra,cca <putc>
  while(--i >= 0)
     d68:	14fd                	addi	s1,s1,-1
     d6a:	ff349ae3          	bne	s1,s3,d5e <printint+0x76>
}
     d6e:	60a6                	ld	ra,72(sp)
     d70:	6406                	ld	s0,64(sp)
     d72:	74e2                	ld	s1,56(sp)
     d74:	7942                	ld	s2,48(sp)
     d76:	79a2                	ld	s3,40(sp)
    ...
    neg = 1;
     d80:	4885                	li	a7,1
    x = -xx;
     d82:	bfbd                	j	d00 <printint+0x18>

0000000000000d84 <vprintf>:
}
...
{
     d84:	7119                	addi	sp,sp,-128
     d86:	fc86                	sd	ra,120(sp)
     d88:	f8a2                	sd	s0,112(sp)
     d8a:	f4a6                	sd	s1,104(sp)
     d8c:	f0ca                	sd	s2,96(sp)
     d8e:	ecce                	sd	s3,88(sp)
     d90:	e8d2                	sd	s4,80(sp)
     d92:	e4d6                	sd	s5,72(sp)
     d94:	e0da                	sd	s6,64(sp)
     d96:	fc5e                	sd	s7,56(sp)
     d98:	f862                	sd	s8,48(sp)
     d9a:	f466                	sd	s9,40(sp)
     d9c:	f06a                	sd	s10,32(sp)
     d9e:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     da6:	24090c63          	beqz	s2,ffe <vprintf+0x27a>
     daa:	8b2a                	mv	s6,a0
     dac:	8a2e                	mv	s4,a1
     dae:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dc2:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     dc6:	00000c97          	auipc	s9,0x0
     dca:	562c8c93          	addi	s9,s9,1378 # 1328 <digits>
     dce:	a005                	j	dee <vprintf+0x6a>
        putc(fd, c0);
     dd0:	85ca                	mv	a1,s2
     dd2:	855a                	mv	a0,s6
     dd4:	ef7ff0ef          	jal	ra,cca <putc>
     dd8:	a019                	j	dde <vprintf+0x5a>
    } else if(state == '%'){
     dda:	03598263          	beq	s3,s5,dfe <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     dde:	2485                	addiw	s1,s1,1
     de0:	8726                	mv	a4,s1
     de2:	009a07b3          	add	a5,s4,s1
     de6:	0007c903          	lbu	s2,0(a5)
     dea:	20090a63          	beqz	s2,ffe <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
     dee:	0009079b          	sext.w	a5,s2
    if(state == 0){
     df2:	fe0994e3          	bnez	s3,dda <vprintf+0x56>
      if(c0 == '%'){
     df6:	fd579de3          	bne	a5,s5,dd0 <vprintf+0x4c>
        state = '%';
     dfa:	89be                	mv	s3,a5
     dfc:	b7cd                	j	dde <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
     dfe:	c3c1                	beqz	a5,e7e <vprintf+0xfa>
     e00:	00ea06b3          	add	a3,s4,a4
     e04:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     e08:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e0a:	c681                	beqz	a3,e12 <vprintf+0x8e>
     e0c:	9752                	add	a4,a4,s4
     e0e:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e12:	03878e63          	beq	a5,s8,e4e <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
     e16:	05a78863          	beq	a5,s10,e66 <vprintf+0xe2>
      } else if(c0 == 'u'){
     e1a:	0db78b63          	beq	a5,s11,ef0 <vprintf+0x16c>
     ...
     e22:	10e78d63          	beq	a5,a4,f3c <vprintf+0x1b8>
     ...
     e2a:	14e78263          	beq	a5,a4,f6e <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     e2e:	06300713          	li	a4,99
     e32:	16e78f63          	beq	a5,a4,fb0 <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     e36:	07300713          	li	a4,115
     e3a:	18e78563          	beq	a5,a4,fc4 <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     e3e:	05579063          	bne	a5,s5,e7e <vprintf+0xfa>
        putc(fd, '%');
     e42:	85d6                	mv	a1,s5
     e44:	855a                	mv	a0,s6
     e46:	e85ff0ef          	jal	ra,cca <putc>
     ...
     e5a:	855a                	mv	a0,s6
     e5c:	e8dff0ef          	jal	ra,ce8 <printint>
     e60:	8bca                	mv	s7,s2
      state = 0;
     e62:	4981                	li	s3,0
     e64:	bfad                	j	dde <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
     e66:	03868663          	beq	a3,s8,e92 <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e6a:	05a68163          	beq	a3,s10,eac <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
     e6e:	09b68d63          	beq	a3,s11,f08 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     e72:	03a68f63          	beq	a3,s10,eb0 <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
     e76:	07800793          	li	a5,120
     e7a:	0cf68d63          	beq	a3,a5,f54 <vprintf+0x1d0>
        putc(fd, '%');
     e7e:	85d6                	mv	a1,s5
     e80:	855a                	mv	a0,s6
     e82:	e49ff0ef          	jal	ra,cca <putc>
        putc(fd, c0);
     e86:	85ca                	mv	a1,s2
     e88:	855a                	mv	a0,s6
     e8a:	e41ff0ef          	jal	ra,cca <putc>
      state = 0;
     e8e:	4981                	li	s3,0
     e90:	b7b9                	j	dde <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     e9e:	855a                	mv	a0,s6
     ea0:	e49ff0ef          	jal	ra,ce8 <printint>
        i += 1;
     ...
     ea8:	4981                	li	s3,0
        i += 1;
     eaa:	bf15                	j	dde <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eac:	03860563          	beq	a2,s8,ed6 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     eb0:	07b60963          	beq	a2,s11,f22 <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     eb4:	07800793          	li	a5,120
     eb8:	fcf613e3          	bne	a2,a5,e7e <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     ec8:	855a                	mv	a0,s6
     eca:	e1fff0ef          	jal	ra,ce8 <printint>
        i += 2;
     ...
     ee2:	855a                	mv	a0,s6
     ee4:	e05ff0ef          	jal	ra,ce8 <printint>
        i += 2;
     ...
     efc:	855a                	mv	a0,s6
     efe:	debff0ef          	jal	ra,ce8 <printint>
     f02:	8bca                	mv	s7,s2
      state = 0;
     f04:	4981                	li	s3,0
     f06:	bde1                	j	dde <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f14:	855a                	mv	a0,s6
     f16:	dd3ff0ef          	jal	ra,ce8 <printint>
        i += 1;
     ...
     f2e:	855a                	mv	a0,s6
     f30:	db9ff0ef          	jal	ra,ce8 <printint>
        i += 2;
     ...
     f48:	855a                	mv	a0,s6
     f4a:	d9fff0ef          	jal	ra,ce8 <printint>
     f4e:	8bca                	mv	s7,s2
      state = 0;
     f50:	4981                	li	s3,0
     f52:	b571                	j	dde <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f60:	855a                	mv	a0,s6
     f62:	d87ff0ef          	jal	ra,ce8 <printint>
        i += 1;
  ...
  putc(fd, '0');
     ...
     f7e:	855a                	mv	a0,s6
     f80:	d4bff0ef          	jal	ra,cca <putc>
  putc(fd, 'x');
     f84:	07800593          	li	a1,120
     f88:	855a                	mv	a0,s6
     f8a:	d41ff0ef          	jal	ra,cca <putc>
     f8e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f9a:	855a                	mv	a0,s6
     f9c:	d2fff0ef          	jal	ra,cca <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     fa0:	0992                	slli	s3,s3,0x4
     fa2:	397d                	addiw	s2,s2,-1
     fa4:	fe0916e3          	bnez	s2,f90 <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
     fa8:	f8843b83          	ld	s7,-120(s0)
      state = 0;
     fac:	4981                	li	s3,0
     fae:	bd05                	j	dde <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
     fb0:	008b8913          	addi	s2,s7,8
     fb4:	000bc583          	lbu	a1,0(s7)
     fb8:	855a                	mv	a0,s6
     fba:	d11ff0ef          	jal	ra,cca <putc>
     fbe:	8bca                	mv	s7,s2
      state = 0;
     fc0:	4981                	li	s3,0
     fc2:	bd31                	j	dde <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
     fc4:	008b8993          	addi	s3,s7,8
     fc8:	000bb903          	ld	s2,0(s7)
     fcc:	00090f63          	beqz	s2,fea <vprintf+0x266>
        for(; *s; s++)
     fd0:	00094583          	lbu	a1,0(s2)
     fd4:	c195                	beqz	a1,ff8 <vprintf+0x274>
          putc(fd, *s);
     fd6:	855a                	mv	a0,s6
     fd8:	cf3ff0ef          	jal	ra,cca <putc>
        for(; *s; s++)
     fdc:	0905                	addi	s2,s2,1
     fde:	00094583          	lbu	a1,0(s2)
     fe2:	f9f5                	bnez	a1,fd6 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
     fe4:	8bce                	mv	s7,s3
      state = 0;
     fe6:	4981                	li	s3,0
     fe8:	bbdd                	j	dde <vprintf+0x5a>
          s = "(null)";
     fea:	00000917          	auipc	s2,0x0
     fee:	33690913          	addi	s2,s2,822 # 1320 <malloc+0x226>
        for(; *s; s++)
     ff2:	02800593          	li	a1,40
     ff6:	b7c5                	j	fd6 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
     ff8:	8bce                	mv	s7,s3
      state = 0;
     ffa:	4981                	li	s3,0
     ffc:	b3cd                	j	dde <vprintf+0x5a>
    }
  }
}
     ffe:	70e6                	ld	ra,120(sp)
    1000:	7446                	ld	s0,112(sp)
    1002:	74a6                	ld	s1,104(sp)
    1004:	7906                	ld	s2,96(sp)
    1006:	69e6                	ld	s3,88(sp)
    1008:	6a46                	ld	s4,80(sp)
    100a:	6aa6                	ld	s5,72(sp)
    100c:	6b06                	ld	s6,64(sp)
    100e:	7be2                	ld	s7,56(sp)
    1010:	7c42                	ld	s8,48(sp)
    1012:	7ca2                	ld	s9,40(sp)
    1014:	7d02                	ld	s10,32(sp)
    1016:	6de2                	ld	s11,24(sp)
    1018:	6109                	addi	sp,sp,128
    101a:	8082                	ret

000000000000101c <fprintf>:
...
fprintf(int fd, const char *fmt, ...)
{
    ...
    1024:	e010                	sd	a2,0(s0)
    1026:	e414                	sd	a3,8(s0)
    1028:	e818                	sd	a4,16(s0)
    102a:	ec1c                	sd	a5,24(s0)
    102c:	03043023          	sd	a6,32(s0)
    1030:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    1034:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    1038:	8622                	mv	a2,s0
    103a:	d4bff0ef          	jal	ra,d84 <vprintf>
}
...
{
    1046:	711d                	addi	sp,sp,-96
    1048:	ec06                	sd	ra,24(sp)
    104a:	e822                	sd	s0,16(sp)
    104c:	1000                	addi	s0,sp,32
    104e:	e40c                	sd	a1,8(s0)
    1050:	e810                	sd	a2,16(s0)
    1052:	ec14                	sd	a3,24(s0)
    1054:	f018                	sd	a4,32(s0)
    1056:	f41c                	sd	a5,40(s0)
    1058:	03043823          	sd	a6,48(s0)
    105c:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    1060:	00840613          	addi	a2,s0,8
    1064:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1068:	85aa                	mv	a1,a0
    106a:	4505                	li	a0,1
    106c:	d19ff0ef          	jal	ra,d84 <vprintf>
}
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    107e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1082:	00001797          	auipc	a5,0x1
    1086:	f8e7b783          	ld	a5,-114(a5) # 2010 <freep>
    108a:	a02d                	j	10b4 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    108c:	4618                	lw	a4,8(a2)
    108e:	9f2d                	addw	a4,a4,a1
    1090:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1094:	6398                	ld	a4,0(a5)
    1096:	6310                	ld	a2,0(a4)
    1098:	a83d                	j	10d6 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    109a:	ff852703          	lw	a4,-8(a0)
    109e:	9f31                	addw	a4,a4,a2
    10a0:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    10a2:	ff053683          	ld	a3,-16(a0)
    10a6:	a091                	j	10ea <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10a8:	6398                	ld	a4,0(a5)
    10aa:	00e7e463          	bltu	a5,a4,10b2 <free+0x3a>
    10ae:	00e6ea63          	bltu	a3,a4,10c2 <free+0x4a>
{
    10b2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10b4:	fed7fae3          	bgeu	a5,a3,10a8 <free+0x30>
    10b8:	6398                	ld	a4,0(a5)
    10ba:	00e6e463          	bltu	a3,a4,10c2 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10be:	fee7eae3          	bltu	a5,a4,10b2 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    10c2:	ff852583          	lw	a1,-8(a0)
    10c6:	6390                	ld	a2,0(a5)
    10c8:	02059813          	slli	a6,a1,0x20
    10cc:	01c85713          	srli	a4,a6,0x1c
    10d0:	9736                	add	a4,a4,a3
    10d2:	fae60de3          	beq	a2,a4,108c <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    10d6:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    10da:	4790                	lw	a2,8(a5)
    10dc:	02061593          	slli	a1,a2,0x20
    10e0:	01c5d713          	srli	a4,a1,0x1c
    10e4:	973e                	add	a4,a4,a5
    10e6:	fae68ae3          	beq	a3,a4,109a <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if(p == SBRK_ERROR)
    ...
    1168:	b7e1                	j	1130 <malloc+0x36>
      if(p->s.size == nunits)
    116a:	02e48c63          	beq	s1,a4,11a2 <malloc+0xa8>
        p->s.size -= nunits;
    ...
    11a6:	bff1                	j	1182 <malloc+0x88>
  hp->s.size = nu;
    11a8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11ac:	0541                	addi	a0,a0,16
    11ae:	ecbff0ef          	jal	ra,1078 <free>
  return freep;
    11b2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    11b6:	dd61                	beqz	a0,118e <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11b8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11ba:	4798                	lw	a4,8(a5)
    11bc:	fa9777e3          	bgeu	a4,s1,116a <malloc+0x70>
    if(p == freep)
    11c0:	00093703          	ld	a4,0(s2)
    11c4:	853e                	mv	a0,a5
    11c6:	fef719e3          	bne	a4,a5,11b8 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
    11ca:	8552                	mv	a0,s4
    11cc:	a2bff0ef          	jal	ra,bf6 <sbrk>
  if(p == SBRK_ERROR)
    11d0:	fd551ce3          	bne	a0,s5,11a8 <malloc+0xae>
        return 0;
    11d4:	4501                	li	a0,0
    11d6:	bf65                	j	118e <malloc+0x94>
