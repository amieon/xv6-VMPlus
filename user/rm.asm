...
main(int argc, char *argv[])
{
  ...
  42:	4509                	li	a0,2
  44:	6b6000ef          	jal	ra,6fa <fprintf>
    exit(1);
  48:	4505                	li	a0,1
  ...
  58:	4509                	li	a0,2
  5a:	6a0000ef          	jal	ra,6fa <fprintf>
      break;
    }
  }
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3d8:	0805c163          	bltz	a1,45a <printint+0x94>
  neg = 0;
 3dc:	4881                	li	a7,0
 ...
 406:	fec773e3          	bgeu	a4,a2,3ec <printint+0x26>
  if(neg)
 40a:	00088b63          	beqz	a7,420 <printint+0x5a>
    buf[i++] = '-';
 40e:	fd078793          	addi	a5,a5,-48
 412:	97a2                	add	a5,a5,s0
 414:	02d00713          	li	a4,45
 418:	fee78423          	sb	a4,-24(a5)
 41c:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
 420:	02f05663          	blez	a5,44c <printint+0x86>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 484:	24090c63          	beqz	s2,6dc <vprintf+0x27a>
 488:	8b2a                	mv	s6,a0
 48a:	8a2e                	mv	s4,a1
 48c:	8bb2                	mv	s7,a2
  state = 0;
 ...
 4a0:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 4a4:	00000c97          	auipc	s9,0x0
 4a8:	45cc8c93          	addi	s9,s9,1116 # 900 <digits>
 4ac:	a005                	j	4cc <vprintf+0x6a>
        putc(fd, c0);
 4ae:	85ca                	mv	a1,s2
 4b0:	855a                	mv	a0,s6
 4b2:	ef7ff0ef          	jal	ra,3a8 <putc>
 4b6:	a019                	j	4bc <vprintf+0x5a>
    } else if(state == '%'){
 4b8:	03598263          	beq	s3,s5,4dc <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 4bc:	2485                	addiw	s1,s1,1
 4be:	8726                	mv	a4,s1
 4c0:	009a07b3          	add	a5,s4,s1
 4c4:	0007c903          	lbu	s2,0(a5)
 4c8:	20090a63          	beqz	s2,6dc <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
 4cc:	0009079b          	sext.w	a5,s2
    if(state == 0){
 4d0:	fe0994e3          	bnez	s3,4b8 <vprintf+0x56>
      if(c0 == '%'){
 4d4:	fd579de3          	bne	a5,s5,4ae <vprintf+0x4c>
        state = '%';
 4d8:	89be                	mv	s3,a5
 4da:	b7cd                	j	4bc <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 4dc:	c3c1                	beqz	a5,55c <vprintf+0xfa>
 4de:	00ea06b3          	add	a3,s4,a4
 4e2:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
 4e6:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 4e8:	c681                	beqz	a3,4f0 <vprintf+0x8e>
 4ea:	9752                	add	a4,a4,s4
 4ec:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 4f0:	03878e63          	beq	a5,s8,52c <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
 4f4:	05a78863          	beq	a5,s10,544 <vprintf+0xe2>
      } else if(c0 == 'u'){
 4f8:	0db78b63          	beq	a5,s11,5ce <vprintf+0x16c>
 ...
 500:	10e78d63          	beq	a5,a4,61a <vprintf+0x1b8>
 ...
 508:	14e78263          	beq	a5,a4,64c <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 50c:	06300713          	li	a4,99
 510:	16e78f63          	beq	a5,a4,68e <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 514:	07300713          	li	a4,115
 518:	18e78563          	beq	a5,a4,6a2 <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 51c:	05579063          	bne	a5,s5,55c <vprintf+0xfa>
        putc(fd, '%');
 520:	85d6                	mv	a1,s5
 522:	855a                	mv	a0,s6
 524:	e85ff0ef          	jal	ra,3a8 <putc>
 ...
 538:	855a                	mv	a0,s6
 53a:	e8dff0ef          	jal	ra,3c6 <printint>
 53e:	8bca                	mv	s7,s2
      state = 0;
 540:	4981                	li	s3,0
 542:	bfad                	j	4bc <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 544:	03868663          	beq	a3,s8,570 <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 548:	05a68163          	beq	a3,s10,58a <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
 54c:	09b68d63          	beq	a3,s11,5e6 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 550:	03a68f63          	beq	a3,s10,58e <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
 554:	07800793          	li	a5,120
 558:	0cf68d63          	beq	a3,a5,632 <vprintf+0x1d0>
        putc(fd, '%');
 55c:	85d6                	mv	a1,s5
 55e:	855a                	mv	a0,s6
 560:	e49ff0ef          	jal	ra,3a8 <putc>
        putc(fd, c0);
 564:	85ca                	mv	a1,s2
 566:	855a                	mv	a0,s6
 568:	e41ff0ef          	jal	ra,3a8 <putc>
      state = 0;
 56c:	4981                	li	s3,0
 56e:	b7b9                	j	4bc <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 57c:	855a                	mv	a0,s6
 57e:	e49ff0ef          	jal	ra,3c6 <printint>
        i += 1;
 ...
 586:	4981                	li	s3,0
        i += 1;
 588:	bf15                	j	4bc <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 58a:	03860563          	beq	a2,s8,5b4 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 58e:	07b60963          	beq	a2,s11,600 <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 592:	07800793          	li	a5,120
 596:	fcf613e3          	bne	a2,a5,55c <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 5a6:	855a                	mv	a0,s6
 5a8:	e1fff0ef          	jal	ra,3c6 <printint>
        i += 2;
 ...
 5c0:	855a                	mv	a0,s6
 5c2:	e05ff0ef          	jal	ra,3c6 <printint>
        i += 2;
 ...
 5da:	855a                	mv	a0,s6
 5dc:	debff0ef          	jal	ra,3c6 <printint>
 5e0:	8bca                	mv	s7,s2
      state = 0;
 5e2:	4981                	li	s3,0
 5e4:	bde1                	j	4bc <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 5f2:	855a                	mv	a0,s6
 5f4:	dd3ff0ef          	jal	ra,3c6 <printint>
        i += 1;
 ...
 60c:	855a                	mv	a0,s6
 60e:	db9ff0ef          	jal	ra,3c6 <printint>
        i += 2;
 ...
 626:	855a                	mv	a0,s6
 628:	d9fff0ef          	jal	ra,3c6 <printint>
 62c:	8bca                	mv	s7,s2
      state = 0;
 62e:	4981                	li	s3,0
 630:	b571                	j	4bc <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 63e:	855a                	mv	a0,s6
 640:	d87ff0ef          	jal	ra,3c6 <printint>
        i += 1;
 ...
 65c:	855a                	mv	a0,s6
 65e:	d4bff0ef          	jal	ra,3a8 <putc>
  putc(fd, 'x');
 662:	07800593          	li	a1,120
 666:	855a                	mv	a0,s6
 668:	d41ff0ef          	jal	ra,3a8 <putc>
 66c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 678:	855a                	mv	a0,s6
 67a:	d2fff0ef          	jal	ra,3a8 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 67e:	0992                	slli	s3,s3,0x4
 680:	397d                	addiw	s2,s2,-1
 682:	fe0916e3          	bnez	s2,66e <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
 686:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 68a:	4981                	li	s3,0
 68c:	bd05                	j	4bc <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
 68e:	008b8913          	addi	s2,s7,8
 692:	000bc583          	lbu	a1,0(s7)
 696:	855a                	mv	a0,s6
 698:	d11ff0ef          	jal	ra,3a8 <putc>
 69c:	8bca                	mv	s7,s2
      state = 0;
 69e:	4981                	li	s3,0
 6a0:	bd31                	j	4bc <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 6a2:	008b8993          	addi	s3,s7,8
 6a6:	000bb903          	ld	s2,0(s7)
 6aa:	00090f63          	beqz	s2,6c8 <vprintf+0x266>
        for(; *s; s++)
 6ae:	00094583          	lbu	a1,0(s2)
 6b2:	c195                	beqz	a1,6d6 <vprintf+0x274>
          putc(fd, *s);
 6b4:	855a                	mv	a0,s6
 6b6:	cf3ff0ef          	jal	ra,3a8 <putc>
        for(; *s; s++)
 6ba:	0905                	addi	s2,s2,1
 6bc:	00094583          	lbu	a1,0(s2)
 6c0:	f9f5                	bnez	a1,6b4 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 6c2:	8bce                	mv	s7,s3
      state = 0;
 6c4:	4981                	li	s3,0
 6c6:	bbdd                	j	4bc <vprintf+0x5a>
          s = "(null)";
 6c8:	00000917          	auipc	s2,0x0
 6cc:	23090913          	addi	s2,s2,560 # 8f8 <malloc+0x120>
        for(; *s; s++)
 6d0:	02800593          	li	a1,40
 6d4:	b7c5                	j	6b4 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 6d6:	8bce                	mv	s7,s3
      state = 0;
 6d8:	4981                	li	s3,0
 6da:	b3cd                	j	4bc <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 712:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 716:	8622                	mv	a2,s0
 718:	d4bff0ef          	jal	ra,462 <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 746:	85aa                	mv	a1,a0
 748:	4505                	li	a0,1
 74a:	d19ff0ef          	jal	ra,462 <vprintf>
}
...
malloc(uint nbytes)
{
 ...
 88c:	ecbff0ef          	jal	ra,756 <free>
  return freep;
 890:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 894:	dd61                	beqz	a0,86c <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 896:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 898:	4798                	lw	a4,8(a5)
 89a:	fa9777e3          	bgeu	a4,s1,848 <malloc+0x70>
    if(p == freep)
 89e:	00093703          	ld	a4,0(s2)
 8a2:	853e                	mv	a0,a5
 8a4:	fef719e3          	bne	a4,a5,896 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 8a8:	8552                	mv	a0,s4
 8aa:	a1bff0ef          	jal	ra,2c4 <sbrk>
  if(p == SBRK_ERROR)
 8ae:	fd551ce3          	bne	a0,s5,886 <malloc+0xae>
        return 0;
 8b2:	4501                	li	a0,0
 8b4:	bf65                	j	86c <malloc+0x94>
