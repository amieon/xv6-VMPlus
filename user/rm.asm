...
main(int argc, char *argv[])
{
  ...
  3e:	89658593          	addi	a1,a1,-1898 # 8d0 <malloc+0xe8>
  42:	4509                	li	a0,2
  44:	6c6000ef          	jal	ra,70a <fprintf>
    exit(1);
  48:	4505                	li	a0,1
  ...
  54:	89858593          	addi	a1,a1,-1896 # 8e8 <malloc+0x100>
  58:	4509                	li	a0,2
  5a:	6b0000ef          	jal	ra,70a <fprintf>
      break;
    }
  }
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3e8:	0805c163          	bltz	a1,46a <printint+0x94>
  neg = 0;
 3ec:	4881                	li	a7,0
 ...
 3f8:	51c50513          	addi	a0,a0,1308 # 910 <digits>
 3fc:	883e                	mv	a6,a5
 ...
 416:	fec773e3          	bgeu	a4,a2,3fc <printint+0x26>
  if(neg)
 41a:	00088b63          	beqz	a7,430 <printint+0x5a>
    buf[i++] = '-';
 ...
 42c:	0028079b          	addiw	a5,a6,2
  ...
  while(--i >= 0)
 430:	02f05663          	blez	a5,45c <printint+0x86>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 494:	24090c63          	beqz	s2,6ec <vprintf+0x27a>
 498:	8b2a                	mv	s6,a0
 49a:	8a2e                	mv	s4,a1
 49c:	8bb2                	mv	s7,a2
  state = 0;
 ...
 4b0:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 4b4:	00000c97          	auipc	s9,0x0
 4b8:	45cc8c93          	addi	s9,s9,1116 # 910 <digits>
 4bc:	a005                	j	4dc <vprintf+0x6a>
        putc(fd, c0);
 4be:	85ca                	mv	a1,s2
 4c0:	855a                	mv	a0,s6
 4c2:	ef7ff0ef          	jal	ra,3b8 <putc>
 4c6:	a019                	j	4cc <vprintf+0x5a>
    } else if(state == '%'){
 4c8:	03598263          	beq	s3,s5,4ec <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 4cc:	2485                	addiw	s1,s1,1
 4ce:	8726                	mv	a4,s1
 4d0:	009a07b3          	add	a5,s4,s1
 4d4:	0007c903          	lbu	s2,0(a5)
 4d8:	20090a63          	beqz	s2,6ec <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
 4dc:	0009079b          	sext.w	a5,s2
    if(state == 0){
 4e0:	fe0994e3          	bnez	s3,4c8 <vprintf+0x56>
      if(c0 == '%'){
 4e4:	fd579de3          	bne	a5,s5,4be <vprintf+0x4c>
        state = '%';
 4e8:	89be                	mv	s3,a5
 4ea:	b7cd                	j	4cc <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 4ec:	c3c1                	beqz	a5,56c <vprintf+0xfa>
 4ee:	00ea06b3          	add	a3,s4,a4
 4f2:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
 4f6:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 4f8:	c681                	beqz	a3,500 <vprintf+0x8e>
 4fa:	9752                	add	a4,a4,s4
 4fc:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 500:	03878e63          	beq	a5,s8,53c <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
 504:	05a78863          	beq	a5,s10,554 <vprintf+0xe2>
      } else if(c0 == 'u'){
 508:	0db78b63          	beq	a5,s11,5de <vprintf+0x16c>
 ...
 510:	10e78d63          	beq	a5,a4,62a <vprintf+0x1b8>
 ...
 518:	14e78263          	beq	a5,a4,65c <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 51c:	06300713          	li	a4,99
 520:	16e78f63          	beq	a5,a4,69e <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 524:	07300713          	li	a4,115
 528:	18e78563          	beq	a5,a4,6b2 <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 52c:	05579063          	bne	a5,s5,56c <vprintf+0xfa>
        putc(fd, '%');
 530:	85d6                	mv	a1,s5
 532:	855a                	mv	a0,s6
 534:	e85ff0ef          	jal	ra,3b8 <putc>
 ...
 548:	855a                	mv	a0,s6
 54a:	e8dff0ef          	jal	ra,3d6 <printint>
 54e:	8bca                	mv	s7,s2
      state = 0;
 550:	4981                	li	s3,0
 552:	bfad                	j	4cc <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 554:	03868663          	beq	a3,s8,580 <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 558:	05a68163          	beq	a3,s10,59a <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
 55c:	09b68d63          	beq	a3,s11,5f6 <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 560:	03a68f63          	beq	a3,s10,59e <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
 564:	07800793          	li	a5,120
 568:	0cf68d63          	beq	a3,a5,642 <vprintf+0x1d0>
        putc(fd, '%');
 56c:	85d6                	mv	a1,s5
 56e:	855a                	mv	a0,s6
 570:	e49ff0ef          	jal	ra,3b8 <putc>
        putc(fd, c0);
 574:	85ca                	mv	a1,s2
 576:	855a                	mv	a0,s6
 578:	e41ff0ef          	jal	ra,3b8 <putc>
      state = 0;
 57c:	4981                	li	s3,0
 57e:	b7b9                	j	4cc <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 58c:	855a                	mv	a0,s6
 58e:	e49ff0ef          	jal	ra,3d6 <printint>
        i += 1;
 ...
 596:	4981                	li	s3,0
        i += 1;
 598:	bf15                	j	4cc <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 59a:	03860563          	beq	a2,s8,5c4 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 59e:	07b60963          	beq	a2,s11,610 <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 5a2:	07800793          	li	a5,120
 5a6:	fcf613e3          	bne	a2,a5,56c <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 5b6:	855a                	mv	a0,s6
 5b8:	e1fff0ef          	jal	ra,3d6 <printint>
        i += 2;
 ...
 5d0:	855a                	mv	a0,s6
 5d2:	e05ff0ef          	jal	ra,3d6 <printint>
        i += 2;
 ...
 5ea:	855a                	mv	a0,s6
 5ec:	debff0ef          	jal	ra,3d6 <printint>
 5f0:	8bca                	mv	s7,s2
      state = 0;
 5f2:	4981                	li	s3,0
 5f4:	bde1                	j	4cc <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 602:	855a                	mv	a0,s6
 604:	dd3ff0ef          	jal	ra,3d6 <printint>
        i += 1;
 ...
 61c:	855a                	mv	a0,s6
 61e:	db9ff0ef          	jal	ra,3d6 <printint>
        i += 2;
 ...
 636:	855a                	mv	a0,s6
 638:	d9fff0ef          	jal	ra,3d6 <printint>
 63c:	8bca                	mv	s7,s2
      state = 0;
 63e:	4981                	li	s3,0
 640:	b571                	j	4cc <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 64e:	855a                	mv	a0,s6
 650:	d87ff0ef          	jal	ra,3d6 <printint>
        i += 1;
 ...
 688:	855a                	mv	a0,s6
 68a:	d2fff0ef          	jal	ra,3b8 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 68e:	0992                	slli	s3,s3,0x4
 690:	397d                	addiw	s2,s2,-1
 692:	fe0916e3          	bnez	s2,67e <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
 696:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 69a:	4981                	li	s3,0
 69c:	bd05                	j	4cc <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
 69e:	008b8913          	addi	s2,s7,8
 6a2:	000bc583          	lbu	a1,0(s7)
 6a6:	855a                	mv	a0,s6
 6a8:	d11ff0ef          	jal	ra,3b8 <putc>
 6ac:	8bca                	mv	s7,s2
      state = 0;
 6ae:	4981                	li	s3,0
 6b0:	bd31                	j	4cc <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 6b2:	008b8993          	addi	s3,s7,8
 6b6:	000bb903          	ld	s2,0(s7)
 6ba:	00090f63          	beqz	s2,6d8 <vprintf+0x266>
        for(; *s; s++)
 6be:	00094583          	lbu	a1,0(s2)
 6c2:	c195                	beqz	a1,6e6 <vprintf+0x274>
          putc(fd, *s);
 6c4:	855a                	mv	a0,s6
 6c6:	cf3ff0ef          	jal	ra,3b8 <putc>
        for(; *s; s++)
 6ca:	0905                	addi	s2,s2,1
 6cc:	00094583          	lbu	a1,0(s2)
 6d0:	f9f5                	bnez	a1,6c4 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 6d2:	8bce                	mv	s7,s3
      state = 0;
 6d4:	4981                	li	s3,0
 6d6:	bbdd                	j	4cc <vprintf+0x5a>
          s = "(null)";
 6d8:	00000917          	auipc	s2,0x0
 6dc:	23090913          	addi	s2,s2,560 # 908 <malloc+0x120>
        for(; *s; s++)
 6e0:	02800593          	li	a1,40
 6e4:	b7c5                	j	6c4 <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
 6e6:	8bce                	mv	s7,s3
      state = 0;
 6e8:	4981                	li	s3,0
 6ea:	b3cd                	j	4cc <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 722:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 726:	8622                	mv	a2,s0
 728:	d4bff0ef          	jal	ra,472 <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 756:	85aa                	mv	a1,a0
 758:	4505                	li	a0,1
 75a:	d19ff0ef          	jal	ra,472 <vprintf>
}
...
malloc(uint nbytes)
{
 ...
 89c:	ecbff0ef          	jal	ra,766 <free>
  return freep;
 8a0:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 8a4:	dd61                	beqz	a0,87c <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8a6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 8a8:	4798                	lw	a4,8(a5)
 8aa:	fa9777e3          	bgeu	a4,s1,858 <malloc+0x70>
    if(p == freep)
 8ae:	00093703          	ld	a4,0(s2)
 8b2:	853e                	mv	a0,a5
 8b4:	fef719e3          	bne	a4,a5,8a6 <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
 8b8:	8552                	mv	a0,s4
 8ba:	a0bff0ef          	jal	ra,2c4 <sbrk>
  if(p == SBRK_ERROR)
 8be:	fd551ce3          	bne	a0,s5,896 <malloc+0xae>
        return 0;
 8c2:	4501                	li	a0,0
 8c4:	bf65                	j	87c <malloc+0x94>
