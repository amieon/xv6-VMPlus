...
main(void)
{
  ...
  46:	89e50513          	addi	a0,a0,-1890 # 8e0 <malloc+0xec>
  4a:	6f6000ef          	jal	ra,740 <printf>
      p[0] = (char)(i + 2);
      exit(0);
    }
  }
  ...
  66:	89650513          	addi	a0,a0,-1898 # 8f8 <malloc+0x104>
  6a:	6d6000ef          	jal	ra,740 <printf>
    exit(1);
  6e:	4505                	li	a0,1
  ...
  82:	89250513          	addi	a0,a0,-1902 # 910 <malloc+0x11c>
  86:	6ba000ef          	jal	ra,740 <printf>
  exit(0);
  8a:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e8:	23490913          	addi	s2,s2,564 # 918 <malloc+0x124>
        for(; *s; s++)
