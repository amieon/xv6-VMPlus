...
main(int argc, char *argv[])
{
  ...
  1a:	95a78793          	addi	a5,a5,-1702 # 970 <malloc+0x114>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	91450513          	addi	a0,a0,-1772 # 940 <malloc+0xe4>
  34:	774000ef          	jal	ra,7a8 <printf>
  ...
  60:	8fc50513          	addi	a0,a0,-1796 # 958 <malloc+0xfc>
  64:	744000ef          	jal	ra,7a8 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	8ce50513          	addi	a0,a0,-1842 # 968 <malloc+0x10c>
  a2:	706000ef          	jal	ra,7a8 <printf>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52c:	460c8c93          	addi	s9,s9,1120 # 988 <digits>
 ...
 750:	23490913          	addi	s2,s2,564 # 980 <malloc+0x124>
        for(; *s; s++)
